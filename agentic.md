...
Career Concierge
December 2025
Career Concierge is an interactive web application designed to help students and early-career professionals streamline the job application process. Users can upload a PDF resume, provide a job description or URL, and instantly receive: A Fit Score and summary explaining how well their resume matches the posting; A Skills Breakdown highlighting strong matches and missing competencies; A personalized, AI-generated Cover Letter; An interactive Career Concierge Chat for follow-up questions and advising. All processing happens within the session, and no data is stored.
